...
public class Question {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getQuestionId() == null ? other.getQuestionId() == null : this.getQuestionId().equals(other.getQuestionId()))
            ...
            && (this.getTestDataPath() == null ? other.getTestDataPath() == null : this.getTestDataPath().equals(other.getTestDataPath()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTestDataPath() == null) ? 0 : getTestDataPath().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", testDataPath=").append(testDataPath);
